    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 font-mono text-sm">
          ...
          <a href="/curriculo-alexandra-carneiro.pdf" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors">~/cv</a>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden glass-panel bg-[#0a0a0f]/95 absolute top-full left-0 w-full flex flex-col items-center py-6 gap-6 font-mono border-t-0 shadow-2xl">
          ...
          <a href="/curriculo-alexandra-carneiro.pdf" target="_blank" rel="noopener noreferrer" className="text-gray-300" onClick={() => setMobileMenuOpen(false)}>~/cv</a>
